...
package com.xingdhl.www.zxinglibrary.camera;
...
import com.xingdhl.www.zxinglibrary.camera.open.OpenCameraInterface;
...
public class CameraManager {
    ...
    public void setFocusOnRect(Rect rect, int surfaceWidth, int surfaceHeight){
        if(rect == null)
            return;

        //将SurfaceView坐标转换为相机对焦坐标（-1000，-1000）--（1000，1000）；
        ...
        autoFocusManager.setFocusOnRect(new Rect(left, top, right, bottom));
    }
}
